...
public class SymlinkCreatorApplicationTest {
    ...
    public void testCreateLinks() throws Exception {
        ...
        dir3.mkdirs();
        dir2.mkdirs();
        final File file1 = new File(dir1, "file1-presentation.jp2");
        file1.createNewFile();
        final File file2 = new File(dir1, "file2-presentation.jp2");
        file2.createNewFile();
        final File filex = new File(dir1, "filex-presentation.jp3");
        filex.createNewFile();
        final File file3 = new File(dir2, "file3-presentation.jp2");
        file3.createNewFile();
        final File file4 = new File(dir3, "file4-presentation.jp2");
        file4.createNewFile();
