...
public class DisseminationRunnableComponent extends AbstractHadoopRunnableComponent {

    private static Logger log = LoggerFactory.getLogger(DisseminationRunnableComponent.class);
     ...
     * @see #getProperties()
     */
    public DisseminationRunnableComponent(Properties properties) {
        super(properties);
    }

    @Override
    protected Tool getTool() {
        return new DisseminationJob();
    }
